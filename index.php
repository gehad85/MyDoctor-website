...
<header class="header">
    ...
    <a href="#" class="logo"> <i class="fas fa-heartbeat"></i> <strong>My</strong>Doctor </a>
        ...
        <div class="box">
            ...
            <div class="content">
                <div class="icon">
                    ...
                    <a href="#"> <i class="fas fa-user"></i> by MyDoctor </a>
                </div>
                <h3>blog title MyDoctor goes here</h3>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-envelope"></i> MyDoctor0@gmail.com </a>
            <a href="#"> <i class="fas fa-envelope"></i> MyDoctor55@gmail.com </a>
            <a href="#"> <i class="fas fa-map-marker-alt"></i> Egypt, Tanta </a>
        </div>
    ...
    <div class="credit"> created by <span>Gehad Megahed</span> | all rights reserved </div>
